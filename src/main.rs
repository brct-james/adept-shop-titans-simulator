...
fn main() {
    ...
    let hc_hm = HashMap::from([(
        ...
        _create_hero_class(
            String::from("Lord"),
            String::from("Titan Soul (Knight)"),
            0,
            0,
            vec![
                84.0, 89.0, 94.0, 99.0, 104.0, 109.0, 114.0, 119.0, 124.0, 134.0, 144.0, 153.0, 163.0, 173.0, 183.0, 193.0, 203.0, 213.0, 223.0, 233.0, 248.0, 263.0, 277.0, 292.0, 307.0, 322.0, 337.0, 352.0, 367.0, 382.0, 401.0, 421.0, 441.0, 461.0, 481.0, 501.0, 520.0, 540.0, 560.0, 580.0
            ],
            vec![
                30.0, 36.0, 41.0, 47.0, 53.0, 58.0, 64.0, 70.0, 76.0, 87.0, 98.0, 110.0, 121.0, 133.0, 144.0, 155.0, 167.0, 178.0, 190.0, 201.0, 218.0, 235.0, 252.0, 269.0, 286.0, 304.0, 321.0, 338.0, 355.0, 372.0, 395.0, 418.0, 440.0, 463.0, 486.0, 509.0, 532.0, 554.0, 577.0, 600.0
            ],
            vec![
                75.0, 82.0, 89.0, 97.0, 104.0, 111.0, 118.0, 126.0, 133.0, 147.0, 162.0, 176.0, 191.0, 205.0, 220.0, 234.0, 249.0, 263.0, 278.0, 292.0, 314.0, 336.0, 358.0, 379.0, 401.0, 423.0, 445.0, 466.0, 488.0, 510.0, 539.0, 568.0, 597.0, 626.0, 655.0, 684.0, 713.0, 742.0, 771.0, 800.0
            ],
            0.0,
            0.05,
            2.0,
            ...
            String::from("Light"),
            [
                vec![String::from("Spear"), String::from("Axe"), String::from("Sword"), String::from("Mace")],
            ...
            [
                ...
                String::from("Knight Lord"),
                String::from("Selfless Hero"),
            ],
        ),
    )]);
